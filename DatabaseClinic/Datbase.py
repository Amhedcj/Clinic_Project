...
def create_patients_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            ...
            {'AttributeName': 'safety_measures', 'AttributeType': 'S'},
...
def create_admissions_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            {'AttributeName': 'admission_id', 'AttributeType': 'N'},
            {'AttributeName': 'patient_id', 'AttributeType': 'N'},
            {'AttributeName': 'discharge_time', 'AttributeType': 'S'},
            {'AttributeName': 'mode_of_discharge', 'AttributeType': 'S'},
            {'AttributeName': 'safety_measures_discharge', 'AttributeType': 'S'}
        ],
...
def create_procedures_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            {'AttributeName': 'procedure_id', 'AttributeType': 'N'},
            {'AttributeName': 'admission_id', 'AttributeType': 'N'},
...
def create_medications_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            ...
            {'AttributeName': 'admission_id', 'AttributeType': 'N'},
            {'AttributeName': 'time', 'AttributeType': 'S'},
            {'AttributeName': 'medication', 'AttributeType': 'S'},
            {'AttributeName': 'dosage', 'AttributeType': 'S'},
            {'AttributeName': 'precautions', 'AttributeType': 'S'},
            {'AttributeName': 'comments', 'AttributeType': 'S'}
        ],
        GlobalSecondaryIndexes=[
...
def create_therapies_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            {'AttributeName': 'therapy_id', 'AttributeType': 'N'},
            {'AttributeName': 'admission_id', 'AttributeType': 'N'},
            {'AttributeName': 'pt', 'AttributeType': 'S'}, 
            {'AttributeName': 'ot', 'AttributeType': 'S'},
            {'AttributeName': 'st', 'AttributeType': 'S'}  # physical therapy (PT), occupational therapy (OT), and speech therapy (ST)
        ],
        GlobalSecondaryIndexes=[
            {
                'IndexName': 'AdmissionIndex',
...
def create_discharges_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            {'AttributeName': 'discharge_id', 'AttributeType': 'N'},
            {'AttributeName': 'admission_id', 'AttributeType': 'N'},
            {'AttributeName': 'discharge_time', 'AttributeType': 'S'},
            {'AttributeName': 'mode_of_discharge', 'AttributeType': 'S'},
            {'AttributeName': 'safety_measures_discharge', 'AttributeType': 'S'},
            {'AttributeName': 'stable', 'AttributeType': 'S'},
            {'AttributeName': 'g_tube_or_trach', 'AttributeType': 'S'},
            {'AttributeName': 'general_assessment', 'AttributeType': 'S'},
            {'AttributeName': 'additional_comments', 'AttributeType': 'S'},
            {'AttributeName': 'nurse_sign', 'AttributeType': 'S'}
        ],
...
def create_intake_output_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            {'AttributeName': 'intake_output_id', 'AttributeType': 'N'},
            {'AttributeName': 'admission_id', 'AttributeType': 'N'},
            {'AttributeName': 'time', 'AttributeType': 'S'},
            {'AttributeName': 'po', 'AttributeType': 'S'},
            {'AttributeName': 'g_tube', 'AttributeType': 'S'},
            {'AttributeName': 'comments', 'AttributeType': 'S'}
        ],
        GlobalSecondaryIndexes=[
            {
...
def create_flow_sheet_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            {'AttributeName': 'admission_id', 'AttributeType': 'N'},
            {'AttributeName': 'time', 'AttributeType': 'S'},
            {'AttributeName': 'temperature', 'AttributeType': 'S'}, 
            {'AttributeName': 'blood_pressure', 'AttributeType': 'S'},
            {'AttributeName': 'heart_rate', 'AttributeType': 'S'},
            {'AttributeName': 'respiratory_rate', 'AttributeType': 'S'},
            {'AttributeName': 'pain_scale', 'AttributeType': 'S'},
            {'AttributeName': 'level_of_consciousness', 'AttributeType': 'S'},
            {'AttributeName': 'activity', 'AttributeType': 'S'},
            {'AttributeName': 'respiratory_effort', 'AttributeType': 'S'},
            {'AttributeName': 'breath_sounds', 'AttributeType': 'S'},
            {'AttributeName': 'fio2_lxm', 'AttributeType': 'S'},
            {'AttributeName': 'sao2', 'AttributeType': 'S'}, 
            {'AttributeName': 'cardiac', 'AttributeType': 'S'}, 
            {'AttributeName': 'heart_sounds', 'AttributeType': 'S'},
            {'AttributeName': 'rhythm', 'AttributeType': 'S'},
            {'AttributeName': 'peripheral_pulse', 'AttributeType': 'S'},
            {'AttributeName': 'capillary_refill', 'AttributeType': 'S'},
            {'AttributeName': 'color', 'AttributeType': 'S'},
            {'AttributeName': 'abdomen', 'AttributeType': 'S'},
            {'AttributeName': 'g_tube_j_tube', 'AttributeType': 'S'},
            {'AttributeName': 'bowel_sounds', 'AttributeType': 'S'},
            {'AttributeName': 'mouth', 'AttributeType': 'S'},
            {'AttributeName': 'stools', 'AttributeType': 'S'},
            {'AttributeName': 'skin_color', 'AttributeType': 'S'},
            {'AttributeName': 'skin_condition', 'AttributeType': 'S'},
            {'AttributeName': 'skin_temperature', 'AttributeType': 'S'},
            {'AttributeName': 'voiding', 'AttributeType': 'S'},
            {'AttributeName': 'catheterization', 'AttributeType': 'S'},
            {'AttributeName': 'adls', 'AttributeType': 'S'},
            {'AttributeName': 'diapers', 'AttributeType': 'S'},
            {'AttributeName': 'emesis', 'AttributeType': 'S'},
            {'AttributeName': 'glasses', 'AttributeType': 'S'},
            {'AttributeName': 'splints_orthotics', 'AttributeType': 'S'},
            {'AttributeName': 'monitors', 'AttributeType': 'S'},
            {'AttributeName': 'feeding_pump', 'AttributeType': 'S'},
            {'AttributeName': 'portable_suction', 'AttributeType': 'S'},
            {'AttributeName': 'hearing_aid', 'AttributeType': 'S'},
            {'AttributeName': 'oxygen', 'AttributeType': 'S'},
            {'AttributeName': 'wheelchair', 'AttributeType': 'S'},
            {'AttributeName': 'nebulizer', 'AttributeType': 'S'},
        ],
        GlobalSecondaryIndexes=[
            {
                'IndexName': 'AdmissionIndex',
...
def create_patient_progress_notes_table():
    table = dynamodb.create_table(
        ...
        AttributeDefinitions=[
            {'AttributeName': 'progress_note_id', 'AttributeType': 'N'},
            {'AttributeName': 'patient_id', 'AttributeType': 'N'},
            {'AttributeName': 'date', 'AttributeType': 'S'},
            {'AttributeName': 'time', 'AttributeType': 'S'},
            {'AttributeName': 'notes', 'AttributeType': 'S'},
            {'AttributeName': 'nurse_signature', 'AttributeType': 'S'}
        ],
        GlobalSecondaryIndexes=[
            {
                'IndexName': 'PatientIndex',
...
def create_medication(medication_id, admission_id, time, medication, dosage, precautions, comments):
...
def update_medication(medication_id, admission_id=None, time=None, medication=None, dosage=None, precautions=None, comments=None):
    table = dynamodb.Table('Medications')
    update_expression = "SET "
    expression_attribute_values = {}
    ...
    if dosage:
        update_expression += "dosage = :dosage, "
        expression_attribute_values[':dosage'] = dosage
    if precautions:
        update_expression += "precautions = :precautions, "
        expression_attribute_values[':precautions'] = precautions
    if comments:
...
def create_discharge(discharge_id, admission_id, discharge_time, mode_of_discharge, safety_measures_discharge, stable, g_tube_or_trach, general_assessment, additional_comments, nurse_sign):
    ...
    response = table.put_item(
       Item={
            ...
            'safety_measures_discharge': safety_measures_discharge,
            'stable': stable,
            'g_tube_or_trach': g_tube_or_trach,
            'general_assessment': general_assessment,
            'additional_comments': additional_comments,
...
def update_discharge(discharge_id, admission_id=None, discharge_time=None, mode_of_discharge=None, safety_measures_discharge=None, stable=None, g_tube_or_trach=None, general_assessment=None, additional_comments=None, nurse_sign=None):
    table = dynamodb.Table('Discharges')
    update_expression = "SET "
    expression_attribute_values = {}
    ...
    if safety_measures_discharge:
        update_expression += "safety_measures = :safety_measures, "
        expression_attribute_values[':safety_measures'] = safety_measures_discharge
    if stable is not None:
        update_expression += "stable = :stable, "
        expression_attribute_values[':stable'] = stable
    if g_tube_or_trach is not None:
...
def create_intake_output(intake_output_id, admission_id, time, po, g_tube, comments):
...
def update_intake_output(intake_output_id, admission_id=None, time=None, po=None, g_tube=None, comments=None):
    table = dynamodb.Table('IntakeOutput')
    update_expression = "SET "
    expression_attribute_values = {}
...
def create_flow_sheet(flow_sheet_id, admission_id, time, temperature, blood_pressure, heart_rate, respiratory_rate, pain_scale, level_of_consciousness, activity, respiratory_effort, breath_sounds, fio2_lxm, sao2, cardiac, heart_sounds, rhythm, peripheral_pulse, capillary_refill, color, abdomen, g_tube_j_tube, bowel_sounds, mouth, stools, skin_color, skin_condition, skin_temperature, voiding, catheterization, adls, diapers, emesis, glasses, splints_orthotics, monitors, feeding_pump, portable_suction, hearing_aid, oxygen, wheelchair, nebulizer):
...
def get_flow_sheet(flow_sheet_id):
    ...
    try:
        ...
        print(f"Error reading FlowSheet: {e}")
        return None
...
def delete_flow_sheet(flow_sheet_id):
    ...
    try:
        ...
        print(f"Error deleting FlowSheet: {e}")
        return None
