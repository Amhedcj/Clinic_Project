...
# Create a session using the default profile from ~/.aws/credentials and ~/.aws/config
session = boto3.Session()

# # Print session information to verify
# print("AWS Access Key:", session.get_credentials().access_key)
# print("AWS Secret Key:", session.get_credentials().secret_key)
# print("Default Region:", session.region_name)
